...
**官方英文文档：[Wireshark_Intro_v6.0.pdf](计算机网络/Computer-Networking-A-Top-Down-Approach-NOTES-master/WiresharkLab/Wireshark实验-Intro/Wireshark_Intro_v6.0.pdf)**  
...
![图2-Wireshark初始界面](图2-Wireshark初始界面.png)
...
![图3-Wireshark抓包和分析时的用户界面](图3-Wireshark抓包和分析时的用户界面.png)
...
![图4-Wireshark抓包接口窗口](图4-Wireshark抓包接口窗口.png)
...
![图5-执行第9步之后的Wireshark窗口](图5-执行第9步之后的Wireshark窗口.png)
