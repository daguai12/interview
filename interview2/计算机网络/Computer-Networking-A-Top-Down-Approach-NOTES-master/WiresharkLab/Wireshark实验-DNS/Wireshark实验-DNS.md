...
![图1](计算机网络/Computer-Networking-A-Top-Down-Approach-NOTES-master/WiresharkLab/Wireshark实验-DNS/image/图1.png)
...
DNS消息的目标端口是53，源端口是53
6. DNS查询消息发送到哪个IP地址？使用ipconfig来确定本地DNS服务器的IP地址。这两个IP地址是否相同？
dns发送到192.168.173.147，本地dns服务器的IP地址为192.168.173.147.这两个IP地址相同
